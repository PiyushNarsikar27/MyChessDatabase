...
$stmt->bindParam(':username',$_SESSION["account"]);
$stmt->execute();
...
<html>
  <head>
    ...
    <title><?php echo($_SESSION["account"])?>'s Showcase</title>
  ...
  <body>
    ...
    <div class="categoryOrGameList">
      <ul>
        <li><a href="categoryPage.php?categoryId=1">Attacking games (<?php echo($stmt2->rowCount());?>)</a></li>
        <li><a href="categoryPage.php?categoryId=2">Positional games (<?php echo($stmt3->rowCount());?>)</a></li>
        <li><a href="categoryPage.php?categoryId=3">Important tournament games (<?php echo($stmt4->rowCount());?>)</a></li>
        <li><a href="categoryPage.php?categoryId=4">Instructive games (<?php echo($stmt5->rowCount());?>)</a></li>
        <li><a href="categoryPage.php?categoryId=5">Heartbreaking losses (<?php echo($stmt6->rowCount());?>)</a></<li>
        <li><a href="categoryPage.php?categoryId=6">Other games (<?php echo($stmt7->rowCount());?>)</a></li>
      </ul>
    </div>
    <div id="shareButton">
